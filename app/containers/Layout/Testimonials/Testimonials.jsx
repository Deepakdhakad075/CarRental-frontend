...
const Testimonials = () => {
  ...
  return (
    <section className="py-16 px-4 sm:px-8 bg-gray-200 to-purple-50">
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-start gap-10 relative">
        ...
        <div className="flex-1 flex flex-col items-start text-center lg:text-left">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-800 leading-tight mb-4">
            What people say <br className="hidden sm:block" /> about <span className="text-red-600">us</span>
          </h2>
        ...
        <div className="flex-1 overflow-hidden w-full relative">
          ...
          >
            {testimonials.map((t, i) => (
              <div
                key={i}
                className="flex-shrink-0 w-full sm:w-[90%] md:w-[80%] bg-white rounded-3xl shadow-xl flex flex-col items-center gap-6 p-6 sm:p-8 transform transition-all hover:scale-105 relative"
              >
                {/* Avatar */}
                <div className="absolute left-1/2 -top-8 transform -translate-x-1/2 rounded-full p-[2px] bg-gradient-to-tr from-indigo-500 to-purple-500">
                  <img
                    src={t.image}
                    alt={t.name}
                ...
                <div className="mt-10 text-center px-2">
                  ...
                  <p className="text-gray-800 text-base sm:text-lg mb-3 font-medium italic leading-relaxed">
                    “{t.feedback}”
                  </p>
                  <h4 className="text-indigo-800 font-bold text-lg">{t.name}</h4>
                  <p className="text-gray-500 text-sm">{t.location}</p>
